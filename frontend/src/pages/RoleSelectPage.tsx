            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              >
                <svg width="18" height="18" viewBox="0 0 100 100" fill="none">
                  ...
                  <path d="M61.35 0.227l-55.333 4.087C.553 4.7 0 7.617 0 11.113v60.66c0 2.723.967 5.053 3.3 8.167l12.007 16.913c2.137 2.723 4.08 3.307 8.16 3.113L88.723 96.08c5.437-.387 6.99-2.917 6.99-7.193V20.64c0-2.21-.82-2.873-3.41-4.757L74.89 3.723C71.57 1.393 69.707.417 63.023.893L61.35.227z" fill="currentColor"/>
                  <path fillRule="evenodd" clipRule="evenodd" d="M25.723 19.127c-5.247.353-6.437.433-9.417-1.99L8.927 11.3c-.78-.587-.39-1.363.78-1.46l52.93-3.887c4.467-.39 6.793.973 8.543 2.333l8.737 6.223c.39.197.973 1.17.193 1.17l-54.58 3.26-.807.187zM19.66 88.3V29.96c0-2.527.78-3.697 3.103-3.893l58.05-3.267c2.14-.193 3.107 1.167 3.107 3.693v57.953c0 2.527-.39 4.67-3.883 4.863l-55.69 3.073c-3.493.193-4.687-1.17-4.687-4.083z" fill="white"/>
                  <path d="M71.907 33.427c.39 1.75 0 3.5-1.75 3.7l-2.723.39v42.827c-2.333 1.167-4.473 1.75-6.217 1.75-2.917 0-3.69-.973-5.83-3.5L36.667 49.953v27.527l5.637 1.17s0 3.5-4.857 3.5l-13.397.78c-.39-.78 0-2.723 1.363-3.11l3.497-.973V42.24l-4.86-.39c-.39-1.75.583-4.277 3.3-4.473l14.367-.973 19.4 29.667V42.047l-4.667-.583c-.39-2.14 1.167-3.693 3.107-3.89l13.16-.78z" fill="white"/>
                </svg>
                노션으로 시작하기
              </button>
            </div>
